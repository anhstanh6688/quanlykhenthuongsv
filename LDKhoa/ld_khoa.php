...
<body>
    ...
    <div class="header-bar">
        <h2>Quản lý khen thưởng/kỷ luật - Lãnh đạo khoa</h2>
        ...
        <div class="form-box">
            ...
            <form method="post" id="formQuyetDinh" onsubmit="return validateForm()">
                ...
                <div class="autocomplete-container">
                    ...
                    <input type="text" placeholder="Nhập mã sinh viên. Ví dụ SV01" name="ma_sv" id="ma_sv_input"
                        required <?php echo $edit_state ? 'readonly' : ''; ?>
                        value="<?php echo htmlspecialchars($edit_ma_sv); ?>" autocomplete="off"
                        onblur="checkMaSV(this.value)" class="<?php echo $edit_state ? '' : 'checkable-input'; ?>">
                ...
                <select name="loai" required id="loai_select">
                    ...
                    <option value="Khen thuong" <?php if ($edit_loai == 'Khen thuong') echo 'selected'; ?>>Khen thưởng
                    </option>
                ...
                <select name="cap_quan_ly" required id="cap_quan_ly_select">
                    ...
                    <option value="Khoa/Vien" <?php if ($edit_cap_quan_ly == 'Khoa/Vien') echo 'selected'; ?>>Khoa/Viện
                    </option>
                ...
                <textarea name="noi_dung" placeholder="Nhập nội dung" rows="3" required
                    id="noi_dung_textarea"><?php echo htmlspecialchars($edit_noi_dung); ?></textarea>
                    ...
                    <tbody>
                        <?php foreach ($danhSachQuyetDinh as $qd) { ?>
                            <tr>
                                ...
                                <td><?php echo isset($qd['nguoi_duyet_ten']) ? htmlspecialchars($qd['nguoi_duyet_ten']) : 'N/A'; ?>
                                </td>
                                <td class="actions">
                                    <a href="ld_khoa.php?edit=<?php echo $qd['id']; ?>" class="btn-edit">Sửa</a>
                                    <a href="ld_khoa.php?delete=<?php echo $qd['id']; ?>" class="btn-delete"
